...
export default function New({ url, title, id, setSearch, description }) {
  return (
    <article className=" mb-5  flex h-[300px] w-[45%] max-w-[150px] flex-col items-center rounded-lg bg-white shadow-light   hover:shadow-hover  dark:bg-black dark:shadow-dark  dark:hover:shadow-hover md:h-[300px] md:w-[200px] md:max-w-[200px]">
      <Link
        href={`/noticias/${id}`}
        onClick={() => setSearch('')}

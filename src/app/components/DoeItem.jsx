...
export default function DoeItem({ title, pix, bank }) {
  return (
    <div className="mb-5 flex  h-[300px] w-[45%] max-w-[150px] flex-col items-center rounded-xl  bg-white p-1 shadow-light hover:shadow-hover dark:bg-black dark:shadow-dark dark:hover:shadow-hover md:mb-5 md:h-[300px] md:w-[200px] md:max-w-[200px]">

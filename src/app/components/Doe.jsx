...
export default function Doe() {
  return (
    <div className="mb-5 flex w-[100vw] flex-col items-center rounded-[35px]  bg-white/20  shadow-lg  dark:bg-black/20 dark:shadow-dark  md:mb-5 md:w-[90vw] md:rounded-xl">
      ...
      <div className=" mb-5 flex w-full px-2 flex-wrap justify-center gap-x-5 p-1 md:gap-x-5">
        <DoeItem
          title="Vila da Penha"

...
export default function Doe() {
  return (
    <div className="mb-5 flex w-[100vw] flex-col items-center rounded-3xl bg-white/20  shadow-lg  dark:bg-black/20 dark:shadow-dark  md:mb-5 md:w-[90vw] md:rounded-xl">

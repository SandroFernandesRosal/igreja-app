...
export default function Locais() {
  return (
    <section className="mb-5 flex w-[100vw] flex-col items-center rounded-[30px]  bg-white/20  shadow-lg dark:bg-black/20  dark:shadow-dark md:w-[90vw] md:rounded-xl">

  ...
  return (
    <section className="mb-5 flex w-[90vw] flex-col items-center rounded-lg bg-white/20 pb-5 shadow-lg dark:bg-black/20 dark:shadow-dark md:w-[90vw]  lg:w-[90vw]">
      ...
      <div className="mb-5 shadow-xl dark:shadow-dark">
        <div className="flex min-h-[350px]  w-[250px] flex-col items-center rounded-lg bg-white shadow-lg dark:bg-black dark:shadow-dark">
          <div className="flex  w-[80%]  flex-1  flex-col gap-2 p-2">
            <h1 className="flex w-full justify-center text-2xl font-bold text-primary">
              Vila da Penha
            </h1>

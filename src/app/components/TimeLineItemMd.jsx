export default function TimeLineItemMd({
  ...
  return (
    <div className="mt-5  hidden min-h-[300px] w-[200px]  flex-col items-center rounded-xl bg-white p-3 shadow-xl hover:shadow-lg hover:shadow-primary dark:bg-black dark:shadow-dark dark:hover:shadow-primary md:flex">

export default function TimeLineItem({
  ...
  return (
    <div className="mt-5 h-[300px] w-[45%] max-w-[150px]  flex-col items-center overflow-hidden rounded-xl bg-white p-2 px-4 shadow-light transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:shadow-hover hover:shadow-primary dark:bg-black dark:shadow-dark dark:hover:shadow-hover md:h-[300px] md:w-[200px] md:max-w-[200px]">

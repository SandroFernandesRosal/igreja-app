export default function TimeLineItem({ title, titletwo, hora, horatwo, day }) {
  return (
    <div className="mb-10 ml-3 mr-3 mt-5  flex  min-h-[350px] w-[250px] flex-col items-center rounded-xl bg-white/60 p-3 shadow-xl hover:shadow-lg hover:shadow-primary dark:bg-black/60 dark:shadow-dark dark:hover:shadow-primary md:hidden">

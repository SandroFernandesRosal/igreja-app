...
export default function Ministerio() {
  return (
    <section className="mb-10  flex w-[100vw] flex-col items-center rounded-3xl bg-white/20  px-1 shadow-lg dark:bg-black/20 dark:shadow-dark  md:w-[90vw] md:rounded-xl">

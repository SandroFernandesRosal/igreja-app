...
export default function EditNew({ openNew, setOpenNew, setOpenEdit, id }) {
  ...
  return (
    <form
      ref={formRef}
      className="fixed left-0 top-0 flex h-[100vh] w-[100vw] flex-col items-center justify-center bg-black/50 backdrop-blur-lg"
      onSubmit={handleSubmit}
    >
      <AiFillCloseCircle
        className="cursor-pointer text-3xl font-bold text-red-500"
